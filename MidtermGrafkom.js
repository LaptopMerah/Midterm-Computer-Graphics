...
var MidtermGrafkom = function () {
  ...
  function startMoving() {
    ...
    timerInterval = setInterval(() => perbaruiKecepatan(speedX, speedY, gayaGesek, gravitasi), waktuInterval);
  }
  ...
  function render() {
    ...
    if (flag) theta[axis] += 2.0;  // Rotasi jika tombol T diklik
  
    modelViewMatrix = mat4();
  
    // Terapkan translasi berdasarkan posisi objek yang diupdate
    modelViewMatrix = mult(modelViewMatrix, translate(objectPositionX, objectPositionY, 0));
  
    // Rotasi objek berdasarkan theta
    ...
    requestAnimationFrame(render);  // Render ulang setiap frame
  }
